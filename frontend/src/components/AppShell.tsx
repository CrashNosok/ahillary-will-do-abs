 ...
 *  тренировки, замеры, вес, InBody, фото, виды спорта. Цели переехали в «Мой кабинет».
 *  Прямые маршруты остаются рабочими (см. App.tsx) для старых ссылок — не дублируются в меню. */
const NAV = [
