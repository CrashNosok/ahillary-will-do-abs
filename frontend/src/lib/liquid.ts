...
/** Единый премиум-градиент ПОЛНОГО дня (3/3): 2 цвета (как у недельной 2/3) — зелёный снизу →
 *  фиолетово-магентовый сверху. Магента совпадает с розовым недели, чтобы день и неделя сочетались.
